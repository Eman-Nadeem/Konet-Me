...
import { MessageSquare, User, Lock, Mail, EyeOff, Eye, Loader, Loader2 } from 'lucide-react';
...
const SignUpPage = () => {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2'>
      ...
      {/* right side */}
      <AuthImagePattern title='Join our community' subtitle='Connnect with friends, share moments, and stay in touch with your loved ones.'/>
    </div>
  )
}
